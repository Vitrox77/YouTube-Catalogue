 ...
 */
final class Version20220325125215 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistics CHANGE nb_coms duration INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistics CHANGE duration nb_coms INT DEFAULT NULL');
